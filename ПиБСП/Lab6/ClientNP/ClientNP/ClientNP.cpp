...
int main()
{
	...
	try
	{
		...
		for (int i = 0; i < countMessage; i++)
		{
			...
			WriteFile(hPipe, newMessage, sizeof(newMessage), &dwWritten, NULL);
			ReadFile(hPipe, newMessage, sizeof(newMessage), &dwWritten, NULL);
			cout << "Get from server: " << newMessage << endl;
		}
		WriteFile(hPipe, "end", sizeof("end"), &dwWritten, NULL);
